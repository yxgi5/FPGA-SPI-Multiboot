...
create_project $project_name ./$project_name -part xc7k325tffg676-2
...
#add_files -fileset sources_1 -norecurse ./hdl/clk_wiz_0.xci
add_files -fileset sources_1 -norecurse ./hdl/clk_wiz_0.xcix
...
set_property top Update [current_fileset]
